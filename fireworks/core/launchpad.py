...
#-------------------------------#
    ...
    def checkout_fw(self, launch_dir: str, fw_id: int=None,
        ...
        """
        m_fw = self._get_a_fw_to_run(self.worker_query, fw_id=fw_id)
        if not m_fw:
            return None
    ...
    def run_exists(self, filter_by_worker: bool=True) -> bool:
        """
